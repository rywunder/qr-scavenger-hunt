...
var AnimalApiProvider = /** @class */ (function () {
    function AnimalApiProvider(http, platform) {
        this.http = http;
    ...
    return AnimalApiProvider;
}());
export { AnimalApiProvider };
//# sourceMappingURL=animal-api.js.map